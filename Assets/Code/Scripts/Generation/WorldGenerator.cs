...
namespace Code.Scripts.Generation
{
    public class WorldGenerator : MonoBehaviour
    {
        ...
        {
            //this.QuadrantFactory.GenerateSingleExitQuadrant(new Vector2Int(0, 0), EDirection.North, 0);
            //this.QuadrantFactory.GenerateDoubleExitQuadrant(new Vector2Int(0, 0), EDirection.North, 0);
